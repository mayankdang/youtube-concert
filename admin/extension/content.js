...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function sendUpdatedPlayerInfoToServer() {
        if (ownerFlag) {
            ...
            var vid=null;
            try {
                vid=youtube_parser($("#movie_player")[0].getVideoUrl());
            }catch (err){

            }
            doSend({a: SYNC_VIDEO, v:((vid!==null)?vid:youtube_parser(window.location.href)), c: concert_parser(window.location.href), o: parseInt(getCurrentVideoOffsetInMillis()),
